...
export default function MovelTVPage() {
  ...
  function criarResumoMovelTV(dados: DadosMovelTV) {
    return `${dados.largura || "—"} x ${dados.altura || "—"} x ${
      dados.profundidade || "—"
    } cm • ${dados.numeroPortas || "0"} portas • ${
      dados.numeroGavetas || "0"
    } gavetas • ${dados.numeroNichos || "0"} nichos • LED: ${
      dados.led || "Não"
    } • Suspenso: ${dados.suspenso || "Não"}`;
  }
  ...
  useEffect(() => {
    ...
    if (!artigo || artigo.tipo !== "Móvel TV" || !artigo.dados) return;
  ...
  function guardarMovelTV() {
    const dadosMovelTV: DadosMovelTV = {
      nomeArtigo,
      largura,
      altura,
      profundidade,
    ...
    const resumo = criarResumoMovelTV(dadosMovelTV);
      ...
      <section style={{ flex: 1, padding: "40px" }}>
        <div style={{ marginBottom: "30px" }}>
          <h1 style={{ fontSize: "38px", margin: 0 }}>
            {editarId ? "Editar Móvel TV" : "Configurar Móvel TV"}
          </h1>
        ...
        <div style={{ maxWidth: "1000px", display: "grid", gap: "20px" }}>
          <div style={cardStyle}>
            ...
            <input
              ...
              placeholder="Ex: Móvel TV Sala Principal"
              style={inputStyle}
            />
          </div>
          ...
          <div style={cardStyle}>
            ...
            <div style={grid3Style}>
              ...
              <div>
                <label style={labelStyle}>Número de Nichos</label>
                <input value={numeroNichos} onChange={(e) => setNumeroNichos(e.target.value)} style={inputStyle} />
              </div>
            </div>
          </div>

          <div style={cardStyle}>
            <h2 style={{ marginTop: 0 }}>Opções</h2>
            <div style={grid2Style}>
              ...
              <div>
                <label style={labelStyle}>Painel Ripado</label>
                <select value={painelRipado} onChange={(e) => setPainelRipado(e.target.value)} style={inputStyle}>
                  <option value="Não">Não</option>
                  <option value="Sim">Sim</option>
                </select>
              </div>
          ...
          <div style={cardStyle}>
            <h2 style={{ marginTop: 0 }}>Embalagem e Montagem</h2>
            <div style={grid2Style}>
              <div>
          ...
          <div style={cardStyle}>
            ...
            <textarea
              ...
              rows={4}
              placeholder="Ex: pormenores técnicos, cablagem, acessórios extra..."
              style={{ ...inputStyle, resize: "vertical" }}
            />
          </div>

          <div style={cardStyle}>
            <h2 style={{ marginTop: 0 }}>Resumo Atual do Móvel TV</h2>
            ...
            <p><strong>Nichos:</strong> {numeroNichos || "—"}</p>
            <p><strong>LED:</strong> {led || "—"}</p>
            <p><strong>Suspenso:</strong> {suspenso || "—"}</p>
            <p><strong>Painel Ripado:</strong> {painelRipado || "—"}</p>
          ...
          >
            ...
            <button onClick={guardarMovelTV} style={botaoPrincipalStyle}>
